...
public class ProyectoHMISPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoHMIS";
	...
	private ProyectoHMISPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoHMISPersistentManager();
		}
