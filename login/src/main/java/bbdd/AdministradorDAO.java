...
public class AdministradorDAO {
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Administrador) session.load(bbdd.Administrador.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Administrador) session.get(bbdd.Administrador.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(bbdd.Administrador.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(bbdd.Administrador.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador createAdministrador() {
		return new bbdd.Administrador();
	}
	
	public static boolean save(bbdd.Administrador administrador) throws PersistentException {
		try {
			bbdd.ProyectoHMISPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(bbdd.Administrador administrador) throws PersistentException {
		try {
			bbdd.ProyectoHMISPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(bbdd.Administrador administrador) throws PersistentException {
		try {
			bbdd.ProyectoHMISPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(bbdd.Administrador administrador) throws PersistentException {
		try {
			bbdd.ProyectoHMISPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
