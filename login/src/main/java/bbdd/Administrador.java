...
public class Administrador implements Serializable {
	...
	@Id	
	@GeneratedValue(generator="BBDD_ADMINISTRADOR_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="BBDD_ADMINISTRADOR_ID_GENERATOR", strategy="native")	
	private int ID;
