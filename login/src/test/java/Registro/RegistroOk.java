...
public class RegistroOk {
  ...
  public void testRegistroOK() throws Exception {
    ...
    driver.findElement(By.id("gwt-uid-7")).sendKeys("Pedro");
    driver.findElement(By.id("gwt-uid-9")).clear();
    driver.findElement(By.id("gwt-uid-9")).sendKeys("peter@ual.es");
    driver.findElement(By.id("gwt-uid-11")).click();
    driver.findElement(By.id("gwt-uid-11")).clear();
    driver.findElement(By.id("gwt-uid-11")).sendKeys("peter");
    driver.findElement(By.id("gwt-uid-13")).click();
    driver.findElement(By.id("gwt-uid-13")).clear();
    driver.findElement(By.id("gwt-uid-13")).sendKeys("peter");
